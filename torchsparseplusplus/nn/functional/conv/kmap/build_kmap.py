...
from torchsparseplusplus.utils import make_ntuple, make_tensor, make_divisible
...
def build_kernel_map(
    ...
    if dataflow == Dataflow.ImplicitGEMM:
        if training:
            ...
            bitmask_bwd = torchsparseplusplus.backend.derive_bitmask_from_out_in_map(
            ...
            reorder_out_in_map_bwd = torchsparseplusplus.backend.reorder_out_in_map_cuda(
                out_in_map_bwd, reorder_loc_bwd
            )
            reduced_sorted_mask_bwd_wgrad = torchsparseplusplus.backend.reduce_bitmask_cuda(
                sorted_mask_bwd, cta_M_wgrad
            )
            reduced_sorted_mask_bwd_dgrad = torchsparseplusplus.backend.reduce_bitmask_cuda(
