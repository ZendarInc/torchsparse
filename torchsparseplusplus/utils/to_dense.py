...
from torchsparseplusplus.utils.utils import make_tensor
...
class ToDenseFunction(Function):
    ...
    def forward(
        ...
        if feats.device.type == "cuda":
            torchsparseplusplus.backend.to_dense_forward_cuda(
    ...
    def backward(ctx, grad_output: torch.Tensor):
        ...
        if grad_output.device.type == "cuda":
            torchsparseplusplus.backend.to_dense_backward_cuda(
